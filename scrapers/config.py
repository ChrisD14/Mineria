...
STORE_SELECTORS = {
    ...
    "novicompu": {
        ...
        "product_name": "h1.vtex-store-components-3-x-productName",
        "product_price": "span.vtex-product-price-1-x-sellingPrice",
        "product_image": "img.vtex-store-components-3-x-productImage",
        "product_overview_container": "div.vtex-store-components-3-x-productDescription",
...
# Umbrales o pesos para el motor de recomendación (ejemplo)
RECOMMENDATION_THRESHOLDS = {
    "gaming_gpu_min": "RTX 3050",
